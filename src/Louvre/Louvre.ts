 ...
 * @param renderOffsetY Vertical offset for render objects
 */
export function graveStoneMasterPiece(object: any, renderOffsetX: number, renderOffsetY: number) {
    return {
        palette: ["#888888"],
        posX: object.x - renderOffsetX,
        posY: object.y - renderOffsetY,
 ...
 * @param renderOffsetY Vertical offset for render objects
 */
export function projectileMasterPiece(object: any, renderOffsetX: number, renderOffsetY: number) {
    return {
...
export function defaultTerrainMasterPiece(object: any, renderOffsetX: number, renderOffsetY: number) {
    return {
        palette: ["#FF00FF"],
        posX: object.x - renderOffsetX,
        posY: object.y - renderOffsetY,
